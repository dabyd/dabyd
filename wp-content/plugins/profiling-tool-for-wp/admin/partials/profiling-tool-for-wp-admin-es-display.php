...
<div class="wrap patp-wrap patp">
    <h1 class="wp-heading-inline">Medir el rendimiento de la página</h1>

    <br /><br />

    <!-- Tab links -->
    <div class="tab">
      <button class="tablinks" onclick="openTab(event, 'pluginProfile')" id="defaultOpen">Plugins & Temas</button>  
      <button class="tablinks" onclick="openTab(event, 'Paginas')">Paginas</button>
    ...
    <div id="Opciones" class="tabcontent">
        <table class="form-table">
            <tbody><tr>
                <th scope="row"><?php echo 'Idioma del plugin'; ?></th>
                <td>
                    <p id="p-lang">
                        <div id="langSelect">
            ...
            <tr>
                <th scope="row"><?php echo 'Orden de clasificación de la tabla'; ?></th>
                <td>
                    <p><label><input type="radio"  name="tableOrd" value="asc" <?php echo $options["TABLE_SORT"]=='asc'?'checked=""':''; ?> id="table-ASC">Ascendente</label></p>
                    <p><label><input type="radio" name="tableOrd" value="desc" <?php echo $options["TABLE_SORT"]=='desc'?'checked=""':''; ?> id="table-DESC">Descendente</label></p>
                </td>
            </tr>
        </tbody>
    </table>
    <div>
    <input type="button" class="button-primary" id="saveProfile" name="save-profile"  value="Guardar Cambios">
</div>
    </div>
      ...
      <div class="postbox" style="display: block;">
                    ...
                    <div class="patp_multilingual-about-info">
                        <div class="top-content">
                            <p class="plugin-description">
                                Presione el botón azul de abajo para medir la página seleccionada
                            </p>
                            <p class="plugin-description">
                                El campo de seleccion de abajo muestra todas las páginas del sitio
                            </p>
                            <p class="plugin-description">
                                Los tiempos de carga siempre varían porque dependen de la velocidad de Internet, caché del sitio, plugins activos, entre otras cosas
                            </p>
                            <p class="plugin-description">
                                Lo mejor para la optimización es lograr tiempos más bajos
                            </p>
                        </div>
                    </div>
                </div>
		...
		<div class="postbox" style="display: block;">
			<div class="postbox-header" style="justify-content: left;">
                <h4 style="padding-right: 10px">Nombre para la prueba: </h4>
				<input class="regular-text" type="text" id="page_profile_name" name="name_page_profile" value="profile_<?php echo date("Ymd"); ?>">
            </div>
		</div>
        <div class="postbox no-bottom"><div class="postbox-header"><h3>Seleccione una página para medir el rendimiento<strong></strong></h3></div></div>
        ...
        <div class="postbox" id="pageTest" style="padding: 15px;">
            ...
            <button class="run_page_button" style="float: right;padding: 7px;background-color: #3276B1;width: 120px;border-radius: 15px;border: none;"><a style="color: white; text-decoration: none;" id="run_quick_page_tests">Comenzar</a></button>
    ...
    <div id="pluginProfile" class="patp-body tabcontent">
            ...
            <div class="inside">
                <div class="patp_multilingual-about">
                    <div class="patp_multilingual-about-info">
                        <div class="top-content">
                            <p class="plugin-description">
                                Presione el botón azul de abajo para medir los plugins
                            </p>
                            <p class="plugin-description">
                                La tabla de abajo muestra los plugins activos actuales
                            </p>
                            <p class="plugin-description">
                                Puede ejecutar la prueba sin ningún plugin o con todos los plugins activos con los enlaces en la tabla
                            </p>
                            <p class="plugin-description">
                                Cada plugin tiene un enlace para ejecutar la prueba sin ese plugin específico
                            </p>
                        </div>
                    </div>
                </div>
		...
		<div class="postbox" style="display: block;">
			<div class="postbox-header" style="justify-content: left;">
                <h3 style="padding-right: 10px">Nombre para la prueba: </h3>
        ...
        <div class="patp_colors-container">
            ...
            <div class="run_button"><a style="color: white; text-decoration: none;" id="run_quick_tests">Comenzar</a></div>
            ...
            <table class="wp-list-table widefat fixed striped table-view-list pages">
				...
				echo '<div class="postbox no-bottom"><div class="postbox-header no-bottom"><h3>Plugins y Temas activos actualmente: <strong>'. $totalElements .'</strong></h3></div></div>';

				echo '<tr>';
				echo '<th> Nombre del Plugin </th>';
				echo '<th> Ejecutar prueba </th>';
				echo '<th> Resultados de la prueba </th>';
				echo '</tr>';

				echo '<tr id="plugin_all">';
				echo '<td><span class="plugin_name hidden">ALL</span><span class="nice_name">Todos Activados</span></td>';
				echo '<td><a class="patp_run_test" href="">Ejecutar prueba con todos los plugins activos</a></td>';
				...
				echo '<td><span class="plugin_name hidden">NONE</span><span class="nice_name">Todos Desactivados</span></td>';
				echo '<td><a class="patp_run_test" href="">Ejecutar prueba sin ningún plugin activo</a></td>';
				...
				foreach($all_active_plugins as $key=>$plugin)
				{
					...
					echo '<td><a class="patp_run_test" href="">Ejecutar prueba solo en este plugin</a></td>';
					...
					foreach ($lista_temas as $key=> $tema) {
						...
						echo '<td><a class="patp_run_test" href="">Ejecutar prueba solo en este tema</a></td>';
						echo '<td><span class="timing hidden"></span><span class="color hidden"></span><span class="result" id="results_'.esc_attr($key).'"></span></td>';
						echo '</tr>';
					}
